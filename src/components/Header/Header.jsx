                        ...
                        item.active ? (
                            <li key={item.name}>
                                <button
                                    ...
                                    className={`inline-block px-1.75 py-1.5 sm:px-2 sm:py-2 md:px-6 md:py-2 text-[13px] sm:text-xs md:text-sm lg:text-base duration-200 hover:bg-blue-100 rounded-full whitespace-nowrap
